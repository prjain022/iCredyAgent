...
SWAGGER_CATEGORY = "icredy-tenant"
...
async def tenant_server_config_handler(request: web.BaseRequest):
    ...
    try:
        del config["plugin_config"]["icredy_innkeeper"]["innkeeper_wallet"]
    ...
    app._state["swagger_dict"]["tags"].append(
        {
            ...
            "description": "iCredy Tenant - tenant self administration (icredy_innkeeper v1_0 plugin)",
        }
    )
